...
export const CartErrorsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'CartErrorsFragment' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'CartUserError' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
...
} as unknown as DocumentNode<CartErrorsFragment, unknown>;
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														...
														{ kind: 'Field', name: { kind: 'Name', value: 'countryCodeV2' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'firstName' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'formatted' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'formattedArea' } },
													],
												},
											},
										],
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'phone' } },
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'CustomerFragment' } }],
									},
								},
							],
						},
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'totalDutyAmount' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'amount' } },
...
export const CustomerErrorsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'CustomerErrorsFragment' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'CustomerUserError' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{ kind: 'Field', name: { kind: 'Name', value: '__typename' } },
...
} as unknown as DocumentNode<CustomerErrorsFragment, unknown>;
export const CustomerFragmentLightFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'CustomerFragmentLight' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Customer' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
...
} as unknown as DocumentNode<CustomerFragmentLightFragment, unknown>;
export const CustomerLightFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'CustomerLightFragment' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Customer' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
...
} as unknown as DocumentNode<CustomerLightFragment, unknown>;
export const CustomerOrderFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
...
} as unknown as DocumentNode<CustomerOrderFragment, unknown>;
...
export const UserErrorsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
...
} as unknown as DocumentNode<UserErrorsFragment, unknown>;
			...
			variableDefinitions: [
				{
					...
					defaultValue: { kind: 'EnumValue', value: 'SE' },
				},
				{
					kind: 'VariableDefinition',
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'CartFragment' } }],
						},
					},
				],
			},
	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'cartInput' } },
						...
						arguments: [
							{
								...
								value: { kind: 'Variable', name: { kind: 'Name', value: 'cartInput' } },
							},
						],
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								...
								},
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'CartErrorsFragment' } }],
									},
								},
							],
						},
	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'buyerIdentity' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'CartBuyerIdentityInput' } },
					},
				},
			],
			selectionSet: {
				...
				selections: [
					{
						...
						arguments: [
							...
							},
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'buyerIdentity' },
								value: { kind: 'Variable', name: { kind: 'Name', value: 'buyerIdentity' } },
							},
						],
						selectionSet: {
							kind: 'SelectionSet',
...
} as unknown as DocumentNode<CartBuyerIdentityUpdateMutation, CartBuyerIdentityUpdateMutationVariables>;
...
} as unknown as DocumentNode<AddItemToCartMutation, AddItemToCartMutationVariables>;
...
export const UpdateItemFromCartDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'UpdateItemFromCart' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'country' } },
...
} as unknown as DocumentNode<UpdateItemFromCartMutation, UpdateItemFromCartMutationVariables>;
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'CustomerFragmentLight' } }],
						},
					},
				],
			},
...
export const CustomerFullDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'CustomerFull' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'accessToken' } },
...
} as unknown as DocumentNode<CustomerFullQuery, CustomerFullQueryVariables>;
export const CustomerOrdersDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'CustomerOrderFragment' } }],
						},
					},
				],
			},
...
} as unknown as DocumentNode<CustomerOrdersQuery, CustomerOrdersQueryVariables>;
...
} as unknown as DocumentNode<CustomerCreateMutation, CustomerCreateMutationVariables>;
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'CustomerAccessTokenCreateInput' } },
					},
				},
			],
			selectionSet: {
						...
						selectionSet: {
							...
							selections: [
								...
								},
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'CustomerErrorsFragment' } }],
									},
								},
							],
						},
...
} as unknown as DocumentNode<CustomerAccessTokenCreateMutation, CustomerAccessTokenCreateMutationVariables>;
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'Field', name: { kind: 'Name', value: 'deletedAccessToken' } },
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'userErrors' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'UserErrorsFragment' } }],
									},
								},
							],
						},
...
} as unknown as DocumentNode<CustomerAccessTokenDeleteMutation, CustomerAccessTokenDeleteMutationVariables>;
							...
							selections: [
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{ kind: 'Field', name: { kind: 'Name', value: 'isoCode' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'name' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'unitSystem' } },
										],
									},
								},
								{
...
export const AllShopifyProductsDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'AllShopifyProducts' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'country' } },
				...
				selections: [
					{
						...
						arguments: [
							...
							},
							{
								...
								value: { kind: 'StringValue', value: 'available_for_sale', block: false },
							},
						],
						selectionSet: {
							kind: 'SelectionSet',
...
} as unknown as DocumentNode<AllShopifyProductsQuery, AllShopifyProductsQueryVariables>;
...
export const ShopifyVariantDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
...
} as unknown as DocumentNode<ShopifyVariantQuery, ShopifyVariantQueryVariables>;
